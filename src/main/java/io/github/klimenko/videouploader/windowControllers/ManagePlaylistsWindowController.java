...
import io.github.klimenko.videouploader.youtube.LocalPlaylist;
    ...
    public void myInit() {
        ...
        txt_newPlaylistName.setOnKeyPressed(event -> {
            ...
            if (event.getCode() == KeyCode.F1) {
                OpenInBrowser.openInBrowser("https://github.com/klimenko-fun/Klimenko-Video-Uploader/wiki/Manage-Playlists");
                event.consume();
            }
        });
