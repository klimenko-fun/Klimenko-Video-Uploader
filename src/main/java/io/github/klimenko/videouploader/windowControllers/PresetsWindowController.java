...
import io.github.klimenko.videouploader.utils.state.VideoPresetState;
...
import io.github.klimenko.videouploader.youtube.utils.VisibilityStatus;
    ...
    public void myInit(boolean disableLocaleChange) {
        ...
        txt_nameNewPreset.setOnKeyPressed(event -> {
            ...
            if (event.getCode() == KeyCode.F1) {
                OpenInBrowser.openInBrowser("https://github.com/klimenko-fun/Klimenko-Video-Uploader/wiki/Preset-Window");
                event.consume();
            }
        });
