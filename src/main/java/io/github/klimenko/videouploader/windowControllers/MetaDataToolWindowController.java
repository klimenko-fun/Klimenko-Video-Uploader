...
import io.github.klimenko.videouploader.tagProcessing.metaDataTagProcessor.MetaDataReader;
    ...
    public void myInit() {
        ...
        MetaDataToolWindow.getScene().setOnKeyPressed(event -> {
            if (event.getCode() == KeyCode.F1) {
                OpenInBrowser.openInBrowser("https://github.com/klimenko-fun/Klimenko-Video-Uploader/wiki/Meta-Data-Tool-Window");
                event.consume();
            }
        });
    }
