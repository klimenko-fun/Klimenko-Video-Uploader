package io.github.klimenko.videouploader.utils;

import io.github.klimenko.videouploader.jfxExtension.WindowFrame;
...
public enum ConfigManager {
    ...
    public void saveSettings() {
        ...
        try {
            ...
            mainProp.store(output, "main settings file for Klimenko Video Uploader");
        } catch (FileNotFoundException e) {
