...
import io.github.klimenko.videouploader.updater.UpdateInfo;
import io.github.klimenko.videouploader.updater.UpdaterCore;
import io.github.klimenko.videouploader.updater.VersionFormat;
...
public class UpdaterUi {
    ...
    private void createUpdateDialog() {
        ...
        dialogStage.setTitle("Updater - Klimenko Video Uploader");
        ...
        dialogStage.getScene().setOnKeyPressed(event -> {
            if (event.getCode() == KeyCode.F1) {
                OpenInBrowser.openInBrowser("https://github.com/klimenko-fun/Klimenko-Video-Uploader/wiki/Update-dialog");
                event.consume();
            }
        });
    }
    ...
    private ButtonType getInstallUpdateButtonChoice(UpdateInfo info) {
        try {
            ...
            return AlertUtils.yesNo(basicTrans.getString("update_available_short") + " - Klimenko Video Uploader",
