...
import io.github.klimenko.videouploader.utils.exceptionHistory.ExceptionHistory;
    ...
    public static void unhandledExceptionDialog(Throwable exception) {
        ...
        try {
            if (Platform.isFxApplicationThread()) {
                exceptionDialog("Klimenko Video Uploader",
                        "Sorry, something went wrong!", exception);
            } else {
                Platform.runLater(() -> exceptionDialog("Klimenko Video Uploader",
                        "Sorry, something went wrong!", exception));
            }
        } catch (Exception e) {
