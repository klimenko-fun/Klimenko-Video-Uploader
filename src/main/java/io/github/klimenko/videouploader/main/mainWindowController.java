package io.github.klimenko.videouploader.main;
...
import io.github.klimenko.videouploader.utils.FileUtils;
import io.github.klimenko.videouploader.utils.background.OpenInBrowser;
import io.github.klimenko.videouploader.utils.background.PresetApplicator;
import io.github.klimenko.videouploader.utils.background.UpdaterUi;
import io.github.klimenko.videouploader.utils.state.ButtonProperties;
import io.github.klimenko.videouploader.utils.state.VideoUploadState;
...
import io.github.klimenko.videouploader.windowControllers.PresetsWindowController;
import io.github.klimenko.videouploader.youtube.Uploader;
import io.github.klimenko.videouploader.youtube.VideoPreset;
import io.github.klimenko.videouploader.youtube.VideoUpload;
import io.github.klimenko.videouploader.youtube.utils.CategoryUtils;
...
import static io.github.klimenko.videouploader.utils.Constants.*;
import static io.github.klimenko.videouploader.youtube.VideoInformationBase.MAX_THUMB_SIZE;
import static io.github.klimenko.videouploader.youtube.VideoInformationBase.THUMBNAIL_FILE_FORMAT;
    ...
    public void myInit() {
        ...
        scene.setOnKeyPressed((event) -> {
            if (event.getCode() == KeyCode.F1) {
                OpenInBrowser.openInBrowser("https://github.com/klimenko-fun/Klimenko-Video-Uploader/wiki/Main-Window");
                event.consume();
            }
        });
